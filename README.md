...
Les différents datasets ont été croisés grâce à des **jointures Pandas avec `merge()`**, notamment entre les données de population, de sous-nutrition et de disponibilité alimentaire.
...
Plusieurs fonctions Pandas ont été utilisées pour agréger les données par pays ou par année et construire les différents indicateurs :
